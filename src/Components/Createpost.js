...
import { TextField, TextareaAutosize, Autocomplete, createFilterOptions, Grid, Button, Box, IconButton, Paper } from '@mui/material';
...
const Createpost = ({ open, Close }) => {
 ...
 const  handleUploadClick = (event) => {
  ...
  console.log(Post)
  const submit=()=>{
    // let base64Image = img.selectedFile[0].split(';base64,').pop();
    const authordata={
      "bio":author.bio,
      "name":author.name,
    ...
    .catch((err)=>{
      ...
      const Getname=()=>{
        ...
        .then((res)=>{
          ...
          setCat(res.data.map(obj=>obj.categories))
        })
        .catch((err)=>{
          console.log(err,"response")
                    ...
                    <Container>
                      <div className='Author'>
                        ...
                        <Button variant="contained" component="label">
                          Upload
                          <input hidden accept="image/*" multiple type="file" onChange={handleUploadClick} />
                        </Button>
                        </div>
                        &nbsp;
                        &nbsp;
                        ...
                        <div style={{width:"100%"}}>
                          ...
                          <TextField
                            ...
                            label="Name"
                            value={author.name}
                            onChange={(event) => setAuthor({ name: event.target.value,bio:author.bio })}
                            name="name"
                            variant="outlined"
                          />
                          </div>
                          ...
                          <TextareaAutosize
                            ...
                            minRows={3}
                            value={author.bio}
                            onChange={(event) => setAuthor({name:author.name, bio: event.target.value })}
                            placeholder="Bio"
                            style={{ width: '70%', padding: 10, backgroundColor: 'transparent' }}
                          />
                        </div>
                     </div>
                     <br/>
                     ...
                     <div className='Author'>
                        ...
                        <Button variant="contained" component="label">
                          Upload
                          <input hidden accept="image/*" multiple type="file" onChange={handleUploadClick1} />
                        </Button>
                        </div>
                        &nbsp;
                        &nbsp;
                     ...
                     <div>
                      ...
                      <React.Fragment>
                        <div>
                          <Table>
                            <thead style={{ backgroundColor: "#dde1fa", color: "black", cursor: "default" }}>
                              <tr>
                                <th>Description</th>
                                <th>Code</th>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <TextareaAutosize
                                        ...
                                        label="Description"
                                        name='Description'
                                        onChange={e=>COdeonchnage(idx,e.target.value,"Description")}
                                    ...
                                    <td>
                                      <TextareaAutosize
                                        ...
                                        label="Code"
                                        name='Code'
                                        onChange={e=>COdeonchnage(idx,e.target.value,"Code")}
                                        InputLabelProps={{ shrink: true }}
                                        value={field.code}
                                        variant="outlined"
                                      />
                        ...
                        <div style={{ marginLeft: "80%" }}>
                          <Button aria-label="add" id='jorrawremov'
                            onClick={() => Handleadd()}
                          >
                            Add more +
                          </Button>
